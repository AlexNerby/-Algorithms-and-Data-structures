    ...
    public class ListLinked<E> {
        ...
        void addFront(E data)           //добавить спереди
        {
            ...
            {                           //то указываем ссылки начала и конца на новый элемент
                ...
                head.previous = a;      //бывший первый ссылается обратной ссылкой на новый элемент
        ...
        void addBack(E data) {          //добавление в конец списка
            ...
            {                           //то указываем ссылки начала и конца на новый элемент
                ...
                a.previous = tail;      // новый ссылается обратной ссылкой на старый
        ...
        void printReversedList()        //печать списка в обратном порядке
        {
            ListElement t = tail;       //получаем ссылку на последний элемент
            while (t != null)           //пока элемент существуе
            {
                System.out.print(t.data + " "); //печатаем его данные
                t = t.previous;                     //и переключаемся на предыдущий
            }
        }
